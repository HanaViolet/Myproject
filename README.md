...
- **收获**：
  ...
  - 示例：规范化到3NF：
    ...
    ```
- **反思**：
  - 3NF让我有种“把乱七八糟的数据整理清楚”的快感
  - BCNF的严格性让我有点晕，看了好多例子才明白
- **注意事项**：
  - 传递依赖要仔细分析，避免遗漏
  - 过度规范化可能影响查询性能
...
这15周的数据库课程让我从一头雾水到能独立设计数据库，收获满满。SQL模板和示例让我对每个知识点有了更直观的理解，反思和注意事项则记录了我的踩坑经历和成长。学数据库的过程像解谜，既烧脑又有趣，尤其是SQL注入和索引优化让我特别着迷。这份记录不仅是知识总结，也是我努力的见证！
